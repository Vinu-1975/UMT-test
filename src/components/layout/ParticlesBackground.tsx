 ...
 *
 *  - variant="global"  → fixed inset-0 z-0, full viewport
 *  - variant="sidebar" → absolute inset-0 z-0, denser/smaller field
 */
export function ParticlesBackground({ variant = "global" }: Props) {
